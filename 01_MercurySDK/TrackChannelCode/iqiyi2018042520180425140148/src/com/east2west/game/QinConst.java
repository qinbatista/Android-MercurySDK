...
public class QinConst {
    ...
    { 
    	...
    	String appidIQIYI="7200";
    	String appsecretIQIYI = "";
		APPID = appidIQIYI;
		APPKEY = appsecretIQIYI;
		ADChannel="";
		SDKPAY="0,1";
		//end		
    }
    ...
    public static void PayInfo(String SavePid)
    {
		  ...
		  switch (SavePid)
	      {
	          ...
	          case "UnlockGame":										ydpid = "016"; ltpid = "016"; dxpid = "TOOL16";  desc = "自由猎人";     pricefloat = 30.0f; ServerPid=ServerPid15;	ServerPrice=ServerPrice15;ServerDes=ServerDes15;break;
