...
public class InAppDefault extends InAppBase {
	...
	private String Channelname="InAppBILIBILIPAY20180628";
	public static final int OK = 1;	
	private SharedPreferences preferences;
	private BSGameSdk gameSdk;
	private String merchant_id= "204";
	private String app_id= "1213";
	private String server_id= "1435";
	private String app_key= "eu65svd3rzbeujfafrqh92ev7qf9msyx";
	private String secret_key= "wcrc9yhdxmt6tb69m3jxgdqh4x2narke";
	@Override
		...
		public void ChannelPay()
		{
			...
			// 支付操作
					...
					/* 注意这里fee是以分为单位的，以元为单位换算时要先除以100.0 */(int) ((mProductPrice) * 100),
							...
							E2WApp.DeviceId+","+E2WApp.SavePidName+","+InAppBase.OrderID+","+QinConst.exchangeID+","+SdkApplication.msg,notify_url, order_sign, new OrderCallbackListener() {
								@Override
