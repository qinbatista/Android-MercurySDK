...
import com.east2west.game.Show.InAppShowADDefault;
...
public class E2WApp  {
	...
	public void InitE2WSDK(Context ContextForE2wSDK)
	{
		...
		ChannelSplash();
		mInAppShow = new InAppShowADDefault() ;
	...
	public void InitChannel(final APPBaseInterface appcall)
	{
		...
		LogLocal("[E2WApp] Local InitChannel()->appcall="+appcall);
	...
	{
		LogLocal("[E2WApp] Local InitAd()->appcall="+appcall);
		final Context applicationContext = mContext.getApplicationContext();
		mInAppShow.ApplicationInit(SdkApplication.Acontext);
		mInAppShow.init(applicationContext, (Activity)mContext, "", "",appcall);
		
	
	}
	public static void SetADValue()
	{
