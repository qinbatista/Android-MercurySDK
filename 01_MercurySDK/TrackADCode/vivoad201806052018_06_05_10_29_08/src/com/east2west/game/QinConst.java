...
public class QinConst {
	...
	//end
	public static String APPChineseName = "涓�璧风帺闄惰壓";	
    ...
    {
    	ADParamList = ADParamSplit("vivo,2347831e31414b3386a6d98d5b559dda,2c855489eb4f4e51b836a20568dffeeb"); 
    }
    public static String[] convertStrToArray(String str,String symbol){   
        String[] strArray = null;   
        strArray = str.split(symbol); //鎷嗗垎瀛楃涓簊ymbol 鍙互鏄� "," ,鐒跺悗鎶婄粨鏋滀氦缁欐暟缁剆trArray 
        return strArray;
    }
