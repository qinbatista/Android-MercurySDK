...
//endpublic class InAppBILIBILIPAY20180629 extends InAppBase {
	
//comment	private InAppBase mBaseInApp = null;
	private String Channelname="InAppBILIBILIPAY20180629";
...
//		        						+ "\nErrorMessage : " + arg0.getErrorMessage());
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case InAppBILIBILIPAY20180629.OK:
...
//						.show();
	...
	private void makeToast(String result) {
		...
		msg.what = InAppBILIBILIPAY20180629.OK;
		msg.obj = result;
