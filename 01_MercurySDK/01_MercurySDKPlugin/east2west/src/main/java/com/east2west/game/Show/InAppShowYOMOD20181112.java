...
//endpublic class InAppShowYOMOD20181112 extends InAppBase {
//comment	public static String appShow="InAppShowYOMOD20181112";
	...
	public void show_insert(String Scenes) {
		...
		if (ADParamList.length<4)
			return;
		E2WApp.LogLocal("[InAppShow"+appShow+"] show_push="+ADParamList[3]);
		myScenes=Scenes;
		if (TGSDK.couldShowAd(ADParamList[3]))
		{
			TGSDK.showAd(mContext, ADParamList[3]);
		}
		else
		{
	...
	public void show_push(String Scenes) {
		if (ADParamList.length<5)
			return;
		// TODO Auto-generated method stub
		E2WApp.LogLocal("[InAppShow"+appShow+"] show_push="+ADParamList[4]);
		myScenes=Scenes;
		if (TGSDK.couldShowAd(ADParamList[4]))
		{
			TGSDK.showAd(mContext, ADParamList[4]);
		}
		else
		{
			onOnVideoFailed("NotPreparedYet");
	...
	public void show_video(String Scenes) {
		// TODO Auto-generated method stub
		if (ADParamList.length<3)
			return;
		E2WApp.LogLocal("[InAppShow"+appShow+"] show_push="+ADParamList[2]);
		myScenes=Scenes;
