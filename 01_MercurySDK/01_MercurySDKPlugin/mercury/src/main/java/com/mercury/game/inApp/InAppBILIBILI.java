...
public class InAppBILIBILI extends InAppBase {
	
//comment	private InAppBase mBaseInApp = null;
	private String Channelname="InAppBILIBILI";
	...
	final String role_id = "bilibili区"; //角色id
	@Override
	...
	public void ChannelPay()
	{
		...
		String data = String.valueOf((int) (mProductPrice*100)) + String.valueOf(mProductPrice*100) + notify_url + out_trade_number;
		//秘钥为服务端secretKey
