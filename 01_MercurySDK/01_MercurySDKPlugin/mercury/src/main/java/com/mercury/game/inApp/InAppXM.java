...
//comment	private InAppBase mBaseInApp = null;
		...
		MiCommplatform.getInstance().miLogin( (Activity) mContext, new OnLoginProcessListener(){
		    ...
		    public void finishLoginProcess( int code , MiAccountInfo arg1 ) {
		        ...
		        case MiErrorCode.MI_XIAOMI_GAMECENTER_ERROR_CANCEL :
		        	...
		        	onPurchaseCanceled(Channelname+"MI_XIAOMI_GAMECENTER_ERROR_CANCEL");
		        break;
	...
	public void ApplicationInit(Application appcontext)
	{
		...
		E2WApp.LogLocal("["+Channelname+"]->init:InAppBase.ApplicationInit="+appcontext+QinConst.APPID+"_"+QinConst.APPID);
	...
	public void ChannelPay()
	{
		...
		miBuyInfo.setCpUserInfo(E2WApp.DeviceId+","+E2WApp.SavePidName+","+InAppBase.OrderID+","+QinConst.exchangeID+","+SdkApplication.msg); 
