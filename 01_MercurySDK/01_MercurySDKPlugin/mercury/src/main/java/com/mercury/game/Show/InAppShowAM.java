...
//endpublic class InAppShowAM extends InAppBase {
//comment	public static String appShow="AM";
	public void init(Context appContext, Activity context, final String strAppId, final String strAppKey,final APPBaseInterface appcall)
	{
		...
		E2WApp.LogLocal("[InAppShow"+appShow+"] QinConst.ADParamList[1]"+QinConst.ADParamList[1]);
		E2WApp.LogLocal("[InAppShow"+appShow+"] QinConst.ADParamList[2]="+QinConst.ADParamList[2]);
	}
