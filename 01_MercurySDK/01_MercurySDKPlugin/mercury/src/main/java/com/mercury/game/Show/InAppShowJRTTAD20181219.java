...
//endpublic class InAppShowJRTTAD20181219 extends InAppBase {
//comment	public static String appShow="InAppShowJRTTAD20181219";
	...
	public void init(Context appContext, Activity context, final String strAppId, final String strAppKey,final APPBaseInterface appcall)
	{
		...
		ttAdManager.setAppId(ADParamList[1]).setName(QinConst.APPChineseName)
...
//                mttRewardVideoAd.setShowDownLoadBar(false);
				mttRewardVideoAd.setRewardAdInteractionListener(new TTRewardVideoAd.RewardAdInteractionListener() {
					...
					public void onVideoComplete() {
						...
						onOnVideoCompleted("onVideoComplete");
					}
