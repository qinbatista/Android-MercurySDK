...
//endpublic class InAppIQIYI20180628 extends InAppBase {
	
//comment	private InAppBase mBaseInApp = null;
	private String Channelname="InAppIQIYI20180628";
	protected int money;	
            ...
            public void onSuccess() {                     
                ...
                platform.addPaymentListener(new PayListener(){  		
                	...
                	public void paymentResult(int result){
                		...
                		Toast.makeText(mContext, "��ֵ�ɹ�", Toast.LENGTH_SHORT).show();   					
                		onPurchaseSuccess(Channelname);		
                		}else{
                		System.out.println("��ֵʧ��");
                		Toast.makeText(mContext, "��ֵʧ��", Toast.LENGTH_SHORT).show();	
                		E2WApp.LogLocal("[" + Channelname + "] hello"+"��ֵʧ��");
	 ...
	 @SuppressWarnings("unused")
	    private void getUserInfo() {
	    	try {
	            ...
	            if (json != null) {
	                String type = json.getString("type"); // 0���ǻ�Ա�� 1����Ա
	                int level = json.getInt("level"); // ��Ա�ȼ�
...
//					Toast.makeText(MainActivity.this, s, Toast.LENGTH_LONG).show();
	...
	public void DoublePay()
	{
		try {
			...
			builder.setMessage("ѡ��֧����ʽ");
			builder.setTitle("��ʾ");
			builder.setPositiveButton("С��֧��", new OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					ChannelPay();
				}
			});
			builder.setNeutralButton("����֧��", new OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					CarriersPay();
				}
