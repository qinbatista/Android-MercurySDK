...
//				
//				ADParamList = new String[nNum];
//				if(ADParamList.length==0)
//				{
//					LogLocalSystem("[GetRemoteValuesWithPrefix]"+ContainOffers[i]+" don't have keywords:"+key);
//					break;
//				}
//				for(int i1= 0;i1<nNum;i1++)
//				{
//					LogLocalSystem("------[GetRemoteValuesWithPrefix]ADParamList["+i+"]="+ADParamList[i]);
//					ADParamList[i1] = jArroy.getString(i1);
//					
//				}		
		    }
		} 	
